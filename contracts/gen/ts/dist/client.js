export const commandRegistry = [
    ...
    },
    {
        ...
        "stability": "beta",
        "surface": "utility",
        "agent_notes": "Requires Bearer access token. `allow_human_lockout=true` is an explicit break-glass path that can leave the workspace without an active human principal; include a non-empty `human_lockout_reason`.",
        "examples": [
            {
                "title": "Revoke self",
        ...
        "body_schema": {
            "optional": [
                {
                    "name": "allow_human_lockout",
                    "type": "boolean"
                },
                {
                    "name": "human_lockout_reason",
                    "type": "string"
                }
            ]
        },
    ...
    },
    {
        ...
        "output_envelope": "Returns `{ principals, active_human_principal_count, next_cursor? }` ordered by create time descending.",
        "error_codes": [
            "auth_required",
            "invalid_token",
            "agent_revoked",
    ...
    },
    {
        ...
        "stability": "beta",
        "surface": "utility",
        "agent_notes": "Requires Bearer access token. Set `allow_human_lockout=true` only for explicit break-glass recovery work and include a non-empty `human_lockout_reason`.",
        "examples": [
            {
    ...
    },
    {
        ...
        "summary": "List ordered board cards",
        "why": "Read canonical board membership, column placement, and rank ordering without hydrating the full board workspace.",
        "input_mode": "none",
        "streaming": {
            "mode": "none"
        },
        "output_envelope": "Returns `{ board_id, cards }` ordered by canonical column sequence and per-column rank.",
        "error_codes": [
            "invalid_request",
            "not_found"
        ],
    ...
    },
    {
        ...
        "output_envelope": "Returns `{ board, card }` after the move is applied.",
        "error_codes": [
            "invalid_json",
            "invalid_request",
            "unknown_actor_id",
    ...
    },
    {
        ...
        "go_method": "BoardsCardsUpdate",
        "ts_method": "boardsCardsUpdate"
    },
    {
        ...
        "output_envelope": "Returns `{ board }` with server-owned identity and concurrency metadata.",
        "error_codes": [
            "invalid_json",
            "invalid_request",
            "unknown_actor_id",
        ...
        "body_schema": {
            ...
            "optional": [
                ...
                {
                    "name": "board.primary_document_id",
                    "type": "string"
                },
                {
                    "name": "board.status",
    ...
    },
    {
        ...
        "summary": "List boards with derived summary data",
    ...
    },
    {
        ...
        "output_envelope": "Returns `{ board }` after the metadata patch is applied.",
        "error_codes": [
            "invalid_json",
            "invalid_request",
            "unknown_actor_id",
        ...
        "body_schema": {
            ...
            "optional": [
                ...
                {
                    "name": "patch.primary_document_id",
                    "type": "any|string"
                },
                {
                    "name": "patch.status",
    ...
    {
        "command_id": "notifications.dismiss",
        "cli_path": "notifications dismiss",
        "group": "notifications",
        "method": "POST",
        "path": "/agent-notifications/dismiss",
        "operation_id": "dismissAgentNotification",
        "summary": "Dismiss an agent notification",
        "why": "Suppress future push wake delivery for one wake notification.",
        "input_mode": "json-body",
        "streaming": {
            "mode": "none"
        },
        "output_envelope": "Returns `{ event, notification }` after the dismiss transition.",
        "error_codes": [
            "auth_required",
            "invalid_json",
            "invalid_request",
        ...
        "stability": "beta",
        "surface": "canonical",
        "agent_notes": "Only the authenticated target agent can dismiss a notification.",
        "examples": [
            {
        ...
        "go_method": "NotificationsDismiss",
        "ts_method": "notificationsDismiss"
    },
    {
        "command_id": "notifications.list",
        "cli_path": "notifications list",
        "group": "notifications",
        "method": "GET",
        "path": "/agent-notifications",
        "operation_id": "listAgentNotifications",
        "summary": "List current agent notifications for the authenticated agent",
        "why": "Read unread, read, or dismissed wake notifications for the current authenticated agent.",
        "input_mode": "none",
        "streaming": {
            "mode": "none"
        },
        "output_envelope": "Returns `{ items, generated_at }` for the current authenticated agent.",
        "error_codes": [
            "auth_required",
            "invalid_request",
            "agent_revoked"
        ...
        "stability": "beta",
        "surface": "projection",
        "agent_notes": "Notification state is derived from canonical wake and notification events. Only the authenticated target agent can read its notifications.",
        "examples": [
            {
        ...
        "go_method": "NotificationsList",
        "ts_method": "notificationsList"
    },
    {
        "command_id": "notifications.read",
        "cli_path": "notifications read",
        "group": "notifications",
        "method": "POST",
        ...
        "output_envelope": "Returns `{ event, notification }` after the read transition.",
        "error_codes": [
            "auth_required",
            "invalid_json",
            "invalid_request",
        ...
        "stability": "beta",
        "surface": "canonical",
        "agent_notes": "Only the authenticated target agent can mark a notification read.",
        "examples": [
            {
        ...
        "go_method": "NotificationsRead",
        "ts_method": "notificationsRead"
    },
    {
    ...
    },
    {
        ...
        "output_envelope": "Returns `{ thread_id, thread, context, collaboration, board_memberships, inbox, pending_decisions, related_threads, follow_up, section_kinds }`, with explicit section classifications.",
        "error_codes": [
            "invalid_request",
            "not_found"
        ],
...
export class OarClient {
    ...
    notificationsDismiss(options = {}) {
        return this.invoke("notifications.dismiss", {}, options);
    }
    notificationsList(options = {}) {
        return this.invoke("notifications.list", {}, options);
    }
    notificationsRead(options = {}) {
        return this.invoke("notifications.read", {}, options);
    }
