    ...
    threads: [
      {
        ...
        cadence: "daily",
        current_summary:
          "NorthWave's pilot launch is at risk. Customer feedback says daily digests hide card owners and due dates, escalation inboxes duplicate threads after updates, and artifact visibility in thread timelines is inconsistent. Product wants a limited pilot rescue plan by Friday without promising a platform rewrite.",
        next_actions: [
      ...
      },
      {
        ...
        cadence: "daily",
        current_summary:
          "NorthWave and BriskPay both reported pilot pain. NorthWave's daily digest omits card owners and due dates. BriskPay cannot see supporting artifacts in thread timelines. Support is manually stitching context together for every follow-up.",
        next_actions: [
